...
import { normalizeMentorPersonality } from './mentorPersonality';
...
const COPY: Record<MentorContext, Record<MentorPersonality, (habit: string) => string>> = {
  recovery: {
    ...
    Snarky: habit => `So “${habit}” ghosted you yesterday. Show up today before it becomes a trend.`,
  ...
  twoMinute: {
    ...
    Snarky: habit => `Fine. Two minutes of “${habit}”. Try not to sprain something.`,
  ...
  vagueHabit: {
    ...
    Snarky: habit => `“${habit}” is vibes-only. Give it a time or place before it evaporates.`,
  ...
  plateauEasy: {
    ...
    Snarky: habit => `“${habit}” is eating your streak. Maybe shrink it before it shrinks you.`,
  ...
  plateauHard: {
    ...
    Snarky: habit => `“${habit}” is autopilot. Bump the bar or admit you like coasting.`,
  ...
  bundleUnlocked: {
    ...
    Snarky: habit => `Fine, you did “${habit}”. Go collect your prize before you regress.`,
  ...
  commitmentBlocked: {
    ...
    Snarky: habit => `Patience. “${habit}” isn't open until your self-imposed curfew ends.`,
  ...
  missPenalty: {
    ...
    Snarky: habit => `“${habit}” missed twice. You literally asked for this XP haircut.`,
...
export const mentorMessage = (
  ...
  personality: MentorPersonality | 'Sarcastic' = 'Supportive',
  habitTitle = 'this habit',
) => COPY[context][normalizeMentorPersonality(personality)](habitTitle);
